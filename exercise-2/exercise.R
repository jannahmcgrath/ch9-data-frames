...
salaries_2018 <- salaries_2017 + runif(100, -500, 10000)
...
salary_57 <- salaries[salaries$employees == "Employee57", "salaries_2018"]
...
person_biggest_raise <- salaries[salaries$change == highest_raise, "employees"]
